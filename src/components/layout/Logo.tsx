  ...
  return (
    ...
    >
      <path
        ...
        stroke={isFilled ? 'none' : 'var(--color-charcoal)'}
        strokeWidth={isFilled ? 0 : 2.4}
        strokeLinejoin="round"
        strokeLinecap="round"
        fill={isFilled ? 'var(--color-coral)' : 'var(--color-white)'}
      />
      <path
        ...
        fill={isFilled ? 'var(--color-white)' : 'var(--color-coral)'}
      />
    </svg>
  )
}
